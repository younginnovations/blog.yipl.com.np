---
layout: post
title: "Young Innovations weekly #2"
...
This is our second weekly at YIPL which has links to blogs, posts, articles that YIPLites read to learn about technology, tips and tricks, other's experiences. Now these links are here for everyone.  

<!--more-->

Enjoy! the articles which might bring smile in your face as you continue solving the issues that's been bugging you. Happy Weekend!!

####Links:
* [10 promising startups poised to change the way you live, work and play](http://www.entrepreneur.com/slideshow/242954)
...
* [anirudh24seven/material-guidelines](https://github.com/anirudh24seven/material-guidelines)

* [announcing docker toolbox](https://blog.docker.com/2015/08/docker-toolbox/)

* [backdrop filters for background blur effect](https://www.webkit.org/blog/3632/introducing-backdrop-filters/)

* [bdd in laravel: getting started with behat and phpspec](http://www.sitepoint.com/bdd-in-laravel-getting-started-with-behat-and-phpspec/)

* [brandonsavage.net stop returning arrays (use objects instead) - brandonsavage.net](http://www.brandonsavage.net/stop-returning-arrays-use-objects-instead/)

* [capistrano and burnout with lee hambley - maintainer of capistrano - podcast](https://changelog.com/110/)

* [charginghawk/drupal-performance-resources · github](https://github.com/charginghawk/drupal-performance-resources)
...
* [full stack radio - 20: ian landsman - code is not a business](http://fullstackradio.com/episodes/20/)
...
* [leveraging laravel: launching side projects quickly with laravel // speaker deck](https://speakerdeck.com/mattstauffer/leveraging-laravel-launching-side-projects-quickly-with-laravel)

* [list sizes of mysql databases - makandropedia](http://makandracards.com/makandra/1447-list-sizes-of-mysql-databases)
...
* [new apt and yum repos - get latest docker](https://blog.docker.com/2015/07/new-apt-and-yum-repos/)

* [overview of web developer tools for drupal 7 — internetdevels official blog](http://internetdevels.com/web-developer-tools-for-drupal-7)

* [phpspec introduction](http://gnugat.github.io/2015/08/03/phpspec.html)
